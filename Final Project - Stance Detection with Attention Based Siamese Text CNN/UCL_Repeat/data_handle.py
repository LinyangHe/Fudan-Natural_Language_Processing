...
csv_file_body = list(csv.reader(open('train_bodies_original.csv','r',encoding='utf-8')))
header_body = csv_file_body[0]
csv_file_body.remove(header_body)

csv_file_stance = list(csv.reader(open('train_stances_original.csv','r',encoding='utf-8')))
